...
frifariano = sprites.create(img("""
    ...
    """),
    SpriteKind.Player)
controller.move_sprite(frifariano, 100, 100)
scene.set_background_image(img("""
    9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
        ...
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
"""))
scroller.scroll_background_with_speed(-25, 0, scroller.BackgroundLayer.LAYER0)
...
def on_update_interval():
    ...
    zombi = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    zombi.set_position(154, randint(0, 123))
    zombi.set_velocity(-50, 0)
